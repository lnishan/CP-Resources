...
| ☆ | Name | Description |
| --- | --- | --- |
| ★★☆ | [Competitive Programming](https://cpbook.net/), by Steven and Felix Halim | This book contains a collection of relevant data structures, algorithms, and programming tips. It's a well-received book. ... The third edition is free for [download (pdf)](http://www.sso.sy/sites/default/files/competitive%20programming%203_1.pdf). |
